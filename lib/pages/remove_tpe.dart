...
// creating controllers to store value from the TextFieldForm
   ...
   Future outStock( String clientName, int number, String address, Future? future) async {
     await FirebaseFirestore.instance.collection('outStock').add({
     'client Name':clientName,
     'client Phone Number': number,
     'client Address' :address,
       'IMEI': _scanBarcodeResult
     }
     ).whenComplete(() => Get.snackbar("success", "Added to outStock successfully",
